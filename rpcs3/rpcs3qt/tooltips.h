...
public:
	...
	const struct settings
	{
		...
		const QString use_vsh_native_overlay       = tr("Uses VSH's native system menu for PS button presses when a game was launched from VSH.\nWhen disabled, RPCS3's host overlay is used instead.");
